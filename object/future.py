...
if __name__ == '__main__':
    ...
    while 1:
        ...
        for i in range(futurelen-1):
            ...
            v_now = float(lists[3])
            v_pre = float(lists[2])
            v_open = float(lists[1])
            v_high = float(lists[4])
        ...
        os.system('clear')
        for i in range(num):
            print(datalist[i*m], datalist[i*m+1], datalist[i*m+2], datalist[i*m+3],datalist[i*m+4],datalist[i*m+5],datalist[i*m+6], datalist[i*m+7])
